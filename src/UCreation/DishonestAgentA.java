...
public class DishonestAgentA {
    ...
    public DishonestAgentA(String email, String password, String typeU, String adressU, String authorization, String fatherS, String name, String motherS, int nRequest, int aHonest, int aDishonest, String typeConsult, String ip, JTextArea caja, String dp) {
        this.email = email;
